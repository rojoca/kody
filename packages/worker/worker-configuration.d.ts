/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: 688b6d1cf87dab038d6da2ac123db66b)
...
interface __BaseEnv_Env {
	...
	PACKAGE_APP_BASE_URL: "https://rojoca.net";
